    ...
    async def delete_reaction(
        ...
        *,
        ...
        """Shortcut for::
            ...
            await update.callback_query.message.delete_reaction(
                user_id=update.callback_query.from_user.id,
                *args,
                **kwargs
            )

        For the documentation of the arguments, please see :meth:`telegram.Message.delete_reaction`
        ...
        Raises:
            :exc:`TypeError` if :attr:`message` is not accessible.
        """
        return await self._get_message(action="delete_reaction").delete_reaction(
    ...
    async def delete_all_reactions(
        ...
        *,
        ...
        """Shortcut for::
            ...
            await update.effective_chat.delete_all_reactions(
                user_id=update.callback_query.from_user.id,
                *args,
                **kwargs
            )
        ...
        For the documentation of the arguments, please see
        :meth:`telegram.Chat.delete_all_reactions`.
        ...
        Raises:
            :exc:`TypeError` if :attr:`message` is not accessible.
        """
        return await self._get_message(action="delete_all_reactions").chat.delete_all_reactions(
            user_id=self.from_user.id,
            read_timeout=read_timeout,
            write_timeout=write_timeout,
            connect_timeout=connect_timeout,
