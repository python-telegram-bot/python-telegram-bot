...
class Message(MaybeInaccessibleMessage):
    ...
    def __init__(
        ...
        text: str | None = None,
        entities: Sequence["MessageEntity | None"] | None = None,
        caption_entities: Sequence["MessageEntity | None"] | None = None,
        audio: Audio | None = None,
        document: Document | None = None,
        game: Game | None = None,
        photo: Sequence[PhotoSize | None] | None = None,
        sticker: Sticker | None = None,
        video: Video | None = None,
        voice: Voice | None = None,
        video_note: VideoNote | None = None,
        new_chat_members: Sequence[User | None] | None = None,
        ...
        new_chat_photo: Sequence[PhotoSize | None] | None = None,
    ...
    async def reply_poll(
        ...
        explanation_entities: Sequence["MessageEntity | None"] | None = None,
        protect_content: ODVInput[bool] = DEFAULT_NONE,
        message_thread_id: ODVInput[int] = DEFAULT_NONE,
        reply_parameters: "ReplyParameters | None" = None,
        question_parse_mode: ODVInput[str] = DEFAULT_NONE,
        question_entities: Sequence["MessageEntity | None"] | None = None,
        message_effect_id: str | None = None,
        allow_paid_broadcast: bool | None = None,
        *,
        reply_to_message_id: int | None = None,
    ...
    async def reply_invoice(
        ...
        suggested_tip_amounts: Sequence[int | None] | None = None,
        protect_content: ODVInput[bool] = DEFAULT_NONE,
        message_thread_id: ODVInput[int] = DEFAULT_NONE,
        reply_parameters: "ReplyParameters | None" = None,
        message_effect_id: str | None = None,
