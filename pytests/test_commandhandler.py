...
class TestCommandHandler:
    ...
    def ch_test1(self, bot, update):
        test_bot = isinstance(bot, Bot)
        test_update = isinstance(update, Update)
        self.test_flag = test_bot and test_update

    def ch_test2(self, bot, update, user_data=None, chat_data=None):
        self.test_flag = (user_data is not None) or (chat_data is not None)

    def ch_test3(self, bot, update, user_data=None, chat_data=None):
        self.test_flag = (user_data is not None) and (chat_data is not None)

    def ch_test4(self, bot, update, job_queue=None, update_queue=None):
        self.test_flag = (job_queue is not None) or (update_queue is not None)

    def ch_test5(self, bot, update, job_queue=None, update_queue=None):
    ...
    def test_basic(self, dp, message):
        handler = CommandHandler('test', self.ch_test1)
    ...
    def test_command_list(self, message):
        handler = CommandHandler(['test', 'start'], self.ch_test1)
    ...
    def test_with_filter(self, message):
        handler = CommandHandler('test', self.ch_test1, Filters.group)
    ...
    def test_pass_user_or_chat_data(self, dp, message):
        handler = CommandHandler('test', self.ch_test2, pass_user_data=True)
        dp.add_handler(handler)
        ...
        handler = CommandHandler('test', self.ch_test2, pass_chat_data=True)
        dp.add_handler(handler)
        ...
        dp.remove_handler(handler)
        handler = CommandHandler('test', self.ch_test3, pass_chat_data=True, pass_user_data=True)
        dp.add_handler(handler)
    ...
    def test_pass_job_or_update_queue(self, dp, message):
        handler = CommandHandler('test', self.ch_test4, pass_job_queue=True)
        dp.add_handler(handler)
        ...
        dp.remove_handler(handler)
        handler = CommandHandler('test', self.ch_test4, pass_update_queue=True)
        dp.add_handler(handler)
        ...
        dp.remove_handler(handler)
        handler = CommandHandler('test', self.ch_test5, pass_job_queue=True,
