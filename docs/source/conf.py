    ...
    "footer_icons": [
        {
            ...
            "html": (
                ...
                "958.288 1.243.294.26.006.549-.1.868-.32 2.179-1.471 3.304-2.314 3.374-2.33.0"
                ...
                "6.63.448.997.414.214-.02.435-.22.547-.82.365-1.417.786-4.486.906-5.751a1.426 "
        ...
        {  # Github logo
            ...
            "html": (
                ...
                "2.39 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.4"
                "9-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23"
                ".82.72 1.21 1.87.87 2.33.66.07-.52.38-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 "
                "0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.3.82.64-.18 1.32-.2"
                "7 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.3-.82 2.3-.82.44 1.1.16 1.92.08 2.12.5"
                "1.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 "
                '1.93-.01 2.3 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z">'
                "</path></svg>"
            ),
            "class": "",
        },
        {  # PTB website logo - globe
            ...
            "html": (
                ...
                "1.855-.143.268-.276.56-.395.872.705.157 1.472.357 2.382.387V1.077zM4.249 3.53"
                ...
                "c.91.03 1.783.145 2.591.332.323-.827.364-1.754.4-2.741H8.5zm-3.282 3.696c.12.31"
                "2.352.604.395.872.552 1.035 1.218 1.65 1.887 1.855V11.91c-.81.03-1.577.13-2.38"
                "2.387zm.11 2.376a6.696 6.696 0 0 1-.598-.933 8.853 8.853 0 0 1-.481-1.079 8.38 "
                "8.38 0 0 0-1.198.49 7.01 7.01 0 0 0 2.376 1.522zm-1.383-2.964A13.36 13.36 0 0 1"
                " 3.508 8.5h-2.49a6.963 6.963 0 0 0 1.362 3.675c.47-.258.995-.482 1.565-.667zm"
                "6.728 2.964a7.009 7.009 0 0 0 2.375-1.521 8.376 8.376 0 0 0-1.197-.49 8.853 "
                ...
                "94.482 1.078a8.368 8.368 0 0 0 1.196-.49 7.01 7.01 0 0 0-2.375-1.52c.218.283.4"
                "18.597.597.932zm-.488 1.343a7.765 7.765 0 0 0-.395-.872C9.835 1.897 9.17 1.282 "
                '8.5 1.077V4.09c.81-.03 1.577-.13 2.382-.287z"></path></svg>'
            ),
            "class": "",
        },
    ],
