    ...
    "footer_icons": [
        {
            ...
            "html": (
                ...
                '<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.287 5.906c-.778.324-2.434.994'
        ...
        {  # Github logo
            ...
            "html": (
                ...
                ".82.72 1.21 1.87.87 2.43.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 "
        ...
        {  # PTB website logo - globe
            ...
            "html": (
                ...
                "9.124 0 0 1-1.565-.667A6.964 6.964 0 0 0 1.018 7.5h2.49zm1.4-2.741a12.444 "
                "12.444 0 0 0-.4 2.741H7.5V5.091c-.91-.03-1.783-.145-2.591-.332zM8.5 5.09V7.5h"
                "2.99a12.442 12.442 0 0 0-.399-2.741c-.808.187-1.681.301-2.591.332zM4.51 8.5c.03"
                "5.987.176 1.914.399 2.741A13.612 13.612 0 0 1 7.5 10.91V8.5H4.51zm3.99 0v2.409"
                "c.91.03 1.783.145 2.591.332.223-.827.364-1.754.4-2.741H8.5zm-3.282 3.696c.12.41"
