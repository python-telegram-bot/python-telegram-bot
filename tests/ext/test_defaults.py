...
class TestDefaults:
    ...
    def test_gift_premium_subscription_text_parse_mode(self):
        defaults = Defaults()
        assert defaults.gift_premium_subscription_text_parse_mode is None
        assert "gift_premium_subscription_text_parse_mode" not in defaults.api_defaults
