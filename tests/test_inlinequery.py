...
class TestInlineQuery:
    ...
    def test_answer(self, monkeypatch, inline_query):
        ...
        assert check_shortcut_call(inline_query.answer, inline_query._bot, 'answer_inline_query')
        assert check_defaults_handling(inline_query.answer, inline_query._bot)

        monkeypatch.setattr(inline_query._bot, 'answer_inline_query', make_assertion)
