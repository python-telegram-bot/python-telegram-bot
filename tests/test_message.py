...
class TestMessage:
    ...
    async def test_edit_general_forum_topic(self, monkeypatch, message):
        async def make_assertion(*_, **kwargs):
            return kwargs["chat_id"] == message.chat_id and kwargs["name"] == "WhatAName"

        assert check_shortcut_signature(
            Message.edit_general_forum_topic,
        ...
        assert await check_defaults_handling(message.edit_general_forum_topic, message.get_bot())

        monkeypatch.setattr(message.get_bot(), "edit_general_forum_topic", make_assertion)
        assert await message.edit_general_forum_topic(name="WhatAName")

    async def test_close_general_forum_topic(self, monkeypatch, message):
        async def make_assertion(*_, **kwargs):
            return kwargs["chat_id"] == message.chat_id

        assert check_shortcut_signature(
            Message.close_general_forum_topic,
        ...
        assert await check_defaults_handling(message.close_general_forum_topic, message.get_bot())

        monkeypatch.setattr(message.get_bot(), "close_general_forum_topic", make_assertion)
        assert await message.close_general_forum_topic()

    async def test_reopen_general_forum_topic(self, monkeypatch, message):
        async def make_assertion(*_, **kwargs):
            return kwargs["chat_id"] == message.chat_id

        assert check_shortcut_signature(
            Message.reopen_general_forum_topic,
        ...
        assert await check_defaults_handling(message.reopen_general_forum_topic, message.get_bot())

        monkeypatch.setattr(message.get_bot(), "reopen_general_forum_topic", make_assertion)
        assert await message.reopen_general_forum_topic()

    async def test_hide_general_forum_topic(self, monkeypatch, message):
        async def make_assertion(*_, **kwargs):
            return kwargs["chat_id"] == message.chat_id

        assert check_shortcut_signature(
            Message.hide_general_forum_topic,
        ...
        assert await check_defaults_handling(message.hide_general_forum_topic, message.get_bot())

        monkeypatch.setattr(message.get_bot(), "hide_general_forum_topic", make_assertion)
        assert await message.hide_general_forum_topic()

    async def test_unhide_general_forum_topic(self, monkeypatch, message):
        async def make_assertion(*_, **kwargs):
            return kwargs["chat_id"] == message.chat_id

        assert check_shortcut_signature(
            Message.unhide_general_forum_topic,
        ...
        assert await check_defaults_handling(message.unhide_general_forum_topic, message.get_bot())

        monkeypatch.setattr(message.get_bot(), "unhide_general_forum_topic", make_assertion)
        assert await message.unhide_general_forum_topic()
