...
class TestDocument:
    ...
    def test_get_file_instance_method(self, monkeypatch, document):
        ...
        assert check_shortcut_call(document.get_file, document._bot, 'get_file')
        assert check_defaults_handling(document.get_file, document._bot)

        monkeypatch.setattr(document._bot, 'get_file', make_assertion)
