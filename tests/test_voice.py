...
class TestVoice:
    ...
    def test_get_file_instance_method(self, monkeypatch, voice):
        ...
        assert check_shortcut_call(voice.get_file, voice._bot, 'get_file')
        assert check_defaults_handling(voice.get_file, voice._bot)

        monkeypatch.setattr(voice._bot, 'get_file', make_assertion)
