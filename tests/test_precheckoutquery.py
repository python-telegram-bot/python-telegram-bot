...
class TestPreCheckoutQuery:
    ...
    def test_de_json(self, bot):
        ...
        assert pre_checkout_query._bot is bot
    ...
    def test_answer(self, monkeypatch, pre_checkout_query):
        ...
        assert check_shortcut_call(
            ...
            pre_checkout_query._bot,
            'answer_pre_checkout_query',
        )
        assert check_defaults_handling(pre_checkout_query.answer, pre_checkout_query._bot)

        monkeypatch.setattr(pre_checkout_query._bot, 'answer_pre_checkout_query', make_assertion)
