...
class TestCallbackQuery:
    ...
    def test_answer(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_call(
            callback_query.answer, callback_query._bot, 'answer_callback_query'
        )
        assert check_defaults_handling(callback_query.answer, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'answer_callback_query', make_assertion)
        # TODO: PEP8
    ...
    def test_edit_message_text(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.edit_message_text, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'edit_message_text', make_assertion)
    ...
    def test_edit_message_caption(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.edit_message_caption, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'edit_message_caption', make_assertion)
    ...
    def test_edit_message_reply_markup(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(
            callback_query.edit_message_reply_markup, callback_query._bot
        )

        monkeypatch.setattr(callback_query._bot, 'edit_message_reply_markup', make_assertion)
    ...
    def test_edit_message_media(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.edit_message_media, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'edit_message_media', make_assertion)
    ...
    def test_edit_message_live_location(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(
            callback_query.edit_message_live_location, callback_query._bot
        )

        monkeypatch.setattr(callback_query._bot, 'edit_message_live_location', make_assertion)
    ...
    def test_stop_message_live_location(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(
            callback_query.stop_message_live_location, callback_query._bot
        )

        monkeypatch.setattr(callback_query._bot, 'stop_message_live_location', make_assertion)
    ...
    def test_set_game_score(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.set_game_score, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'set_game_score', make_assertion)
    ...
    def test_get_game_high_scores(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.get_game_high_scores, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'get_game_high_scores', make_assertion)
    ...
    def test_delete_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_call(
            callback_query.delete_message, callback_query._bot, 'delete_message'
        )
        assert check_defaults_handling(callback_query.delete_message, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'delete_message', make_assertion)
    ...
    def test_pin_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_call(
            callback_query.pin_message, callback_query._bot, 'pin_chat_message'
        )
        assert check_defaults_handling(callback_query.pin_message, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'pin_chat_message', make_assertion)
    ...
    def test_unpin_message(self, monkeypatch, callback_query):
        ...
        assert check_defaults_handling(callback_query.unpin_message, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'unpin_chat_message', make_assertion)
    ...
    def test_copy_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_call(
            callback_query.copy_message, callback_query._bot, 'copy_message'
        )
        assert check_defaults_handling(callback_query.copy_message, callback_query._bot)

        monkeypatch.setattr(callback_query._bot, 'copy_message', make_assertion)
