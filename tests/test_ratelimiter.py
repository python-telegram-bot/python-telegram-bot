...
@pytest.mark.skipif(
    TEST_WITH_RATE_LIMITER, reason="Only relevant if the optional dependency is not installed"
)
...
@pytest.mark.skipif(
    not TEST_WITH_RATE_LIMITER, reason="Only relevant if the optional dependency is installed"
)
@pytest.mark.skipif(
