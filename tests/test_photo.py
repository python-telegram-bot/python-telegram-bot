...
class TestPhoto:
    ...
    def test_get_file_instance_method(self, monkeypatch, photo):
        ...
        assert check_shortcut_call(photo.get_file, photo._bot, 'get_file')
        assert check_defaults_handling(photo.get_file, photo._bot)

        monkeypatch.setattr(photo._bot, 'get_file', make_assertion)
