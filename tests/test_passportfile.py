...
class TestPassportFile:
    ...
    def test_get_file_instance_method(self, monkeypatch, passport_file):
        ...
        assert check_shortcut_call(passport_file.get_file, passport_file._bot, 'get_file')
        assert check_defaults_handling(passport_file.get_file, passport_file._bot)

        monkeypatch.setattr(passport_file._bot, 'get_file', make_assertion)
