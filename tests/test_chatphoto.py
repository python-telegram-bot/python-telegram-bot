...
class TestChatPhoto:
    ...
    def test_get_small_file_instance_method(self, monkeypatch, chat_photo):
        ...
        assert check_shortcut_call(chat_photo.get_small_file, chat_photo._bot, 'get_file')
        assert check_defaults_handling(chat_photo.get_small_file, chat_photo._bot)

        monkeypatch.setattr(chat_photo._bot, 'get_file', make_assertion)
    ...
    def test_get_big_file_instance_method(self, monkeypatch, chat_photo):
        ...
        assert check_shortcut_call(chat_photo.get_big_file, chat_photo._bot, 'get_file')
        assert check_defaults_handling(chat_photo.get_big_file, chat_photo._bot)
