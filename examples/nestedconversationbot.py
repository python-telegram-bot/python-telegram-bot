...
def start(update: Update, context: DefaultContextType) -> str:
...
def adding_self(update: Update, context: DefaultContextType) -> str:
...
def show_data(update: Update, context: DefaultContextType) -> str:
...
def stop(update: Update, context: DefaultContextType) -> int:
...
def select_level(update: Update, context: DefaultContextType) -> str:
...
def select_gender(update: Update, context: DefaultContextType) -> str:
...
def end_second_level(update: Update, context: DefaultContextType) -> int:
...
def select_feature(update: Update, context: DefaultContextType) -> str:
...
def ask_for_input(update: Update, context: DefaultContextType) -> str:
...
def save_input(update: Update, context: DefaultContextType) -> str:
...
def end_describing(update: Update, context: DefaultContextType) -> int:
...
def stop_nested(update: Update, context: DefaultContextType) -> str:
