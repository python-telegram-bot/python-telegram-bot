...
====================
    ...
    You are reading the documentation of V13. This version is currently in "Bot API compatibility mode", so will only get updates to include new Bot API features.
