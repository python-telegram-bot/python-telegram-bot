...
class Dice(TelegramObject):
    ...
    Note:
        ...
        can be found at our `wiki <https://github.com/python-telegram-bot/python-telegram-bot/wiki/Code-snippets#map-a-slot-machine-dice-value-to-the-corresponding-symbols>`_. However, this behaviour is undocumented
