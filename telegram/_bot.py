...
class Bot(TelegramObject):
    ...
    def send_message(
        ...
        Args:
            ...
            text (:obj:`str`): Text of the message to be sent. Max
                :attr:`telegram.constants.MessageLimit.TEXT_LENGTH` characters after entities
    ...
    def send_photo(
        ...
        Args:
            ...
            caption (:obj:`str`, optional): Photo caption (may also be used when resending photos
                by file_id), 0-:attr:`telegram.constants.MessageLimit.CAPTION_LENGTH` characters
    ...
    def send_audio(
        ...
        :attr:`telegram.constants.FileSizeLimit.FILESIZE_UPLOAD` in size, this limit may be changed
        in the future.
    ...
    def send_document(
        ...
        :attr:`telegram.constants.FileSizeLimit.FILESIZE_UPLOAD` in size, this limit may be
        ...
        Args:
            ...
            caption (:obj:`str`, optional): Document caption (may also be used when resending
                documents by file_id), 0-:attr:`telegram.constants.MessageLimit.CAPTION_LENGTH`
    ...
    def send_animation(
        ...
        Args:
            ...
            caption (:obj:`str`, optional): Animation caption (may also be used when resending
                animations by file_id), 0-:attr:`telegram.constants.MessageLimit.CAPTION_LENGTH`
                characters after entities parsing.
            parse_mode (:obj:`str`, optional): Send Markdown or HTML, if you want Telegram apps to
                show bold, italic, fixed-width text or inline URLs in the media caption. See the
                constants in :class:`telegram.constants.ParseMode` for the available modes.
    ...
    def send_voice(
        ...
        send voice messages of up to :attr:`telegram.constants.FileSizeLimit.FILESIZE_UPLOAD` in
    ...
    def answer_inline_query(
        ...
        :attr:`telegram.InlineQuery.MAX_RESULTS` results per query are allowed.
    ...
    def get_file(
        ...
        :attr:`telegram.constants.FileSizeLimit.FILESIZE_DOWNLOAD` in size. The file can then be
        downloaded
    ...
    def answer_callback_query(
        ...
        Args:
            ...
            text (:obj:`str`, optional): Text of the notification. If not specified, nothing will
                be shown to the user, 0-:attr:`telegram.CallbackQuery.MAX_ANSWER_TEXT_LENGTH`
                characters.
    ...
    def send_poll(
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): Unique identifier for the target chat or username
                of the target channel (in the format ``@channelusername``).
            question (:obj:`str`): Poll question, 1-:attr:`telegram.Poll.MAX_QUESTION_LENGTH`
                characters.
            options (List[:obj:`str`]): List of answer options,
                2-:attr:`telegram.Poll.MAX_OPTION_NUMBER` strings
                1-:attr:`telegram.Poll.MAX_OPTION_LENGTH` characters each.
    ...
    def send_dice(
        ...
        Args:
            ...
            emoji (:obj:`str`, optional): Emoji on which the dice throw animation is based.
                ...
                values 1-6 for :attr:`telegram.constants.DiceEmoji.DICE`,
                :attr:`telegram.constants.DiceEmoji.DARTS` and
                :attr:`telegram.constants.DiceEmoji.BOWLING`, values 1-5 for
                :attr:`telegram.constants.DiceEmoji.BASKETBALL` and
                :attr:`telegram.constants.DiceEmoji.FOOTBALL`, and values 1-64
                for :attr:`telegram.constants.DiceEmoji.SLOT_MACHINE`. Defaults to
                :attr:`telegram.constants.DiceEmoji.DICE`.

                .. versionchanged:: 13.4
                   Added the :attr:`telegram.constants.DiceEmoji.BOWLING` emoji.
            disable_notification (:obj:`bool`, optional): Sends the message silently. Users will
                receive a notification with no sound.
            reply_to_message_id (:obj:`int`, optional): If the message is a reply, ID of the
                original message.
