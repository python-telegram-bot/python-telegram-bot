...
class CallbackQuery(TelegramObject):
    ...
    Note:
        ...
        * If you're using :attr:`Bot.arbitrary_callback_data`, :attr:`data` may be be an instance
          of :class:`telegram.error.InvalidCallbackData`. This will be the case, if the data
