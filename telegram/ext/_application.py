...
class Application(Generic[BT, CCT, UD, CD, BD, JQ], AsyncContextManager["Application"]):
    ...
    This class is a :class:`~typing.Generic` class and accepts five type variables:
    ...
    2. The type of the values of :attr:`user_data`.
    3. The type of the values of :attr:`chat_data`.
    4. The type of :attr:`bot_data`.
    5. The type of :attr:`job_queue`. Must either be :class:`telegram.ext.JobQueue` or a subclass
        of that or :obj:`None`.
