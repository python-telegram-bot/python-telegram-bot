...
class Bot(TelegramObject):
    ...
    def export_chat_invite_link(
        ...
        Note:
            ...
            links, it will need to generate its own link using :attr:`export_chat_invite_link` or
            by calling the :attr:`get_chat` method. If your bot needs to generate a new primary
