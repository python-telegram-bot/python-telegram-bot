...
Attributes:
    ...
    MAX_FILESIZE_DOWNLOAD (int): In bytes (20MB)
    MAX_FILESIZE_UPLOAD (int): In bytes (50MB)
    MAX_MESSAGES_PER_SECOND_PER_CHAT (int): 1. Telegram may allow short bursts that go over this
...
Attributes:
    MAX_MESSAGE_ENTITIES (int): 100 (Beyond this cap telegram will simply ignore further
            formatting styles)
"""
