...
class ChatFullInfo(TelegramObject):
    ...
    Args:
        ...
        accent_color_id (:obj:`int`): Identifier of the
            ...
            .. versionchanged:: NEXT.VERSION
                This attribute is now required as per Bot API 7.3.
    ...
    Attributes:
        ...
        join_by_request (:obj:`bool`): Optional. :obj:`True`, if all users directly
            joining the supergroup need to be approved by supergroup administrators.
    ...
    def __init__(
        ...
        personal_chat: Optional["ChatFullInfo"] = None,
        ...
        *,
        ...
        self.personal_chat: Optional["ChatFullInfo"] = personal_chat
