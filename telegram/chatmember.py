...
class ChatMember(TelegramObject):
    ...
    Attributes:
        ...
        can_promote_members (:obj:`bool`): Optional. If the administrator can add new
            administrators.
        is_member (:obj:`bool`): Optional. Restricted only. ``True``, if the user is a member of
    ...
    Args:
        ...
        can_be_edited (:obj:`bool`, optional): Administrators only. ``True``, if the bot is
            allowed to edit administrator privileges of that user.
        can_change_info (:obj:`bool`, optional): Administrators and restricted only. ``True``, if
            the user can change the chat title, photo and other settings.
        can_post_messages (:obj:`bool`, optional): Administrators only. ``True``, if the
            administrator can post in the channel, channels only.
        can_edit_messages (:obj:`bool`, optional): Administrators only. ``True``, if the
        ...
        can_invite_users (:obj:`bool`, optional): Administrators and restricted only. ``True``, if
        ...
        can_pin_messages (:obj:`bool`, optional): Administrators and restricted only. ``True``, if
            the user can pin messages, groups and supergroups only.
        ...
        is_member (:obj:`bool`, optional): Restricted only. ``True``, if the user is a member of
            the chat at the moment of the request.
        can_send_messages (:obj:`bool`, optional): Restricted only. ``True``, if the user can send
        ...
        can_send_polls (:obj:`bool`, optional): Restricted only. ``True``, if the user is allowed
            to send polls.
        ...
        can_add_web_page_previews (:obj:`bool`, optional): Restricted only. ``True``, if user may
            add web page previews to his messages.
